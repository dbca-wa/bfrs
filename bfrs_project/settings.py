...
KB_LAYER_URL = env('KB_LAYER_URL', "https://kaartdijin-boodja.dbca.wa.gov.au/api/catalogue/entries/CPT_CADASTRE_BUSHFIRE_RPT/layer/")
...
MAX_GEOJSPLIT_SIZE = env('MAX_GEOJSPLIT_SIZE', (50 * 1024 * 1024))  # Default to 50 MB
