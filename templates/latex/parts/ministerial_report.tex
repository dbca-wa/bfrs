...
Records at {{report_date}} show Department of Biodiversity, Conservation and Attractions (DBCA) staff have attended {{ item_map.forest_total_all_tenure|floatformat:0|intcomma }} bushfires covering an area of {{ item_map.forest_total_area|floatformat:0|intcomma }} hectares in its three south-west forest regions for the period since 1 July {{ current_finyear }}. Of these, {{ item_map.forest_pw_tenure|floatformat:0|intcomma }} fires covering {{ item_map.forest_area_pw_tenure|floatformat:0|intcomma }} hectares occurred on lands where DBCA has a management interest.
\\~\\
