...
Records as at {{report_date}} show number of fires {{ item.map.forest_total_all_tenure }} bushfires have been attended by Department of Biodiversity, Conservation and Attractions (DBCA) staff in its three south-west forest regions, covering an area of {{ item_map.forest_total_area|intcomma }} hectares, for the period since 1 July {{ current_finyear }}. Of these, {{ item_map.forest_pw_tenure }} fires occurred on  DBCA managed lands, covering {{ item_map.forest_area_pw_tenure|intcomma }} hectares. 
\\~\\
Outside the south-west forest regions, records show {{ item_map.nonforest_total_all_tenure }} bushfires attended by DBCA staff have burnt through an area of {{ item_map.nonforest_total_area|intcomma }} hectares. 
\\~\\
...
\subsubsection{Mark Webb \\DIRECTOR GENERAL   \\~\\ {{report_date}} \hfill $\rule{5.5cm}{0.05mm}$ \\ \hfill MINISTER FOR ENVIRONMENT   \\ Att  \\~\\ \hfill Date:$\rule{4.5cm}{0.05mm}$}
\end{minipage}
